...
func (c *bidirectionalServiceClient) Chat(ctx context.Context, opts ...grpc.CallOption) (BidirectionalService_ChatClient, error) {
	stream, err := c.cc.NewStream(ctx, &BidirectionalService_ServiceDesc.Streams[0], "/pb_generated.BidirectionalService/Chat", opts...)
	if err != nil {
		return nil, err
	}
...
var BidirectionalService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "pb_generated.BidirectionalService",
